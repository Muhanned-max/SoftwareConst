...
const StaffSignup = () => {
  ...
  const {signup, error, isLoading} = useStaffSignup()
  ...
  return (
    ...
    <div class="card-header text-center ">Staff Signup</div>
    <div class="card-body">
...
//     <form style={{ marginTop: 120 ,marginLeft: 650 , marginRight:500 ,borderRadius: 20 , borderStyle: 'solid' ,  boxSizing: 'border-box' , height: 500 , padding : 20 , width : 320}} className="staffsignup" onSubmit={handleSubmit}>
//      <head>
//           <link rel="stylesheet" href="./index.css"></link>

//         </head>
//       <h3 style={{textAlign: 'center'}}>Staff Sign Up</h3>
...
//     </body>
    ...
    // <form className="staffsignup" onSubmit={handleSubmit}>
    //   <h3>Sign Up</h3>
